...
public class FileCompressor {
    ...
    private static int maxWidth = 612;
    private static int maxHeight = 816;
    private static Bitmap.CompressFormat compressFormat = Bitmap.CompressFormat.JPEG;
    private static int quality = 80;
    private static String destinationDirectoryPath;
    ...
    public static File compressToFile(File imageFile) throws IOException {
        return compressToFile(imageFile, imageFile.getName());
    }

    public static File compressToFile(File imageFile, String compressedFileName) throws IOException {

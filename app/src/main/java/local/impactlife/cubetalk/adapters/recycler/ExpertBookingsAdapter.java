...
import local.impactlife.cubetalk.activities.ExpertBookingManagementActivity;
import local.impactlife.cubetalk.databinding.ItemCardExpertBookingBinding;
...
import local.impactlife.cubetalk.models.common.User;
...
import local.impactlife.cubetalk.services.api.ConfirmBookingService;
import local.impactlife.cubetalk.services.api.ExpertCancelBookingService;
...
public class ExpertBookingsAdapter extends RecyclerView.Adapter<ExpertBookingsAdapter.ViewHolder> implements
        MesiboCall.MesiboCallListener,Mesibo.CallListener
{
   ...
   SharedPreferences mSharedPreferences;
    ...
    public ExpertBookingsAdapter(List<Booking> bookings, ExpertBookingManagementActivity expertBookingManagementActivity) {
        ...
        mSharedPreferences = expertBookingManagementActivity.getSharedPreferences(local.impactlife.cubetalk.models.User.PREFERENCE_NAME, MODE_PRIVATE);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String currency=(mSharedPreferences.getInt(local.impactlife.cubetalk.models.User.COUNTRYID, 0)== local.impactlife.cubetalk.models.User.INDIACOUNTRYID? "INR ":"INR ");
    ...
    private void callApiforConfirmBook(Context context, String expert_id, String booked_id,int position) {
        ...
        mSharedPreferences = context.getSharedPreferences(local.impactlife.cubetalk.models.User.PREFERENCE_NAME, MODE_PRIVATE);
        String userId = mSharedPreferences.getString(local.impactlife.cubetalk.models.User.ID, "");
        ...
        Call<ExpertConfirmBookingResponse> createRequest = confirmBookingService.getConfirmbookService(mSharedPreferences.getString(local.impactlife.cubetalk.models.User.TOKEN, ""),
    ...
    private void callApiforCancelBooking(Context context, String bookeduserid_id,String bookedid, int position) {
        ...
        Call<ExpertCancelBookingResponse> createRequest = cancelBookingService.getcancelbookService(mSharedPreferences.getString(local.impactlife.cubetalk.models.User.TOKEN, ""),

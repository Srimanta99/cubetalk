...
import local.impactlife.cubetalk.adapters.viewpager2.ExpertDetailsStateAdapter;
import local.impactlife.cubetalk.databinding.ActivityViewExpertDetailsBinding;
import local.impactlife.cubetalk.databinding.ContentViewExpertDetailsBinding;
...
import static local.impactlife.cubetalk.adapters.viewpager2.ExpertDetailsStateAdapter.EXPERT_PROFILE;
import static local.impactlife.cubetalk.adapters.viewpager2.ExpertDetailsStateAdapter.FEEDBACK;
import static local.impactlife.cubetalk.adapters.viewpager2.ExpertDetailsStateAdapter.TIMINGS_AND_FEES;

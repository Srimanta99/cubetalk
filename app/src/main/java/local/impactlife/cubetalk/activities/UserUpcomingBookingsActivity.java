...
import local.impactlife.cubetalk.adapters.recycler.FutureBookingsAdapter;
import local.impactlife.cubetalk.databinding.ActivityUserUpcomingBookingsBinding;
import local.impactlife.cubetalk.databinding.ContentUserUpcomingBookingsBinding;
...
public class UserUpcomingBookingsActivity extends AppCompatActivity implements  MesiboCall.MesiboCallListener, Mesibo.CallListener     {

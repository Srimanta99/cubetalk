package com.cubetalktest.cubetalk.services.firebase;
...
//              PendingIntent.FLAG_ONE_SHOT);
        Intent intent = new Intent(getApplicationContext(), SplashActivity.class); // Here pass your activity where you want to redirect.
      // Uri sound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + getApplicationContext().getPackageName() + "/" + R.raw.testsound);
